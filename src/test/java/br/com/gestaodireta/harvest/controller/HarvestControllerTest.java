...
class HarvestControllerTest extends PostgresIntegrationTest {
    ...
    void shouldReturnHarvestSeasonSummaryForAuthorizedUser() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.planning.plannedMargin").value(54.05))
                ...
                .andExpect(jsonPath("$.projection.projectedMargin").value(39.67))
                .andExpect(jsonPath("$.plannedCostPerHectare").value(804.17))
                .andExpect(jsonPath("$.plannedRevenuePerHectare").value(1750.00))
                .andExpect(jsonPath("$.plannedResultPerHectare").value(945.83))
                .andExpect(jsonPath("$.projectedCostPerHectare").value(754.17))
                .andExpect(jsonPath("$.projectedRevenuePerHectare").value(1250.00))
                .andExpect(jsonPath("$.projectedProfitPerHectare").value(495.83))
                .andExpect(jsonPath("$.realizedCostPerHectare").value(604.17))
                .andExpect(jsonPath("$.realizedRevenuePerHectare").value(1250.00))
                .andExpect(jsonPath("$.realizedProfitPerHectare").value(645.83))
    ...
    void shouldReturnHarvestSeasonSummaryListForAuthorizedUser() throws Exception {
        ...
        mockMvc.perform(
                ...
                .andExpect(jsonPath("$.content[0].planning.plannedMargin").value(54.05))
                .andExpect(jsonPath("$.content[0].projection.projectedCost").value(90500.00))
                .andExpect(jsonPath("$.content[0].projection.projectedRevenue").value(150000.00))
                .andExpect(jsonPath("$.content[0].plannedPerHectare.cost").value(804.17))
                .andExpect(jsonPath("$.content[0].realizedPerHectare.result").value(645.83))
                .andExpect(jsonPath("$.content[0].budgetExecution.executedCost").value(72500.00))
                .andExpect(jsonPath("$.content[0].budgetExecution.percentage").value(75.13))
                .andExpect(jsonPath("$.content[0].commitments.payableAmount").value(18000.00))
                .andExpect(jsonPath("$.content[0].commitments.receivableAmount").value(0.00))
                .andExpect(jsonPath("$.content[0].statusContext.startDatePassed").isBoolean())
